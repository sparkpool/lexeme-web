...
<section class="page page--home">
			...
			<form action="${pageContext.request.contextPath}/search" method="GET">
				...
				<div class="search-form__number-field">
					<input class="search-form__input" dirty
						...
						name="q" class="form-control" aria-label=" " id="searchString"
						ng-model="searchString" placeholder="Search documents"
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<c:if test="${divHide!='false'}">
							<h2 style="text-align: center; padding-top: 40px;">No Result
								Found</h2>
						</c:if>
					</c:otherwise>
				</c:choose>
	...
	<div class='modal fade' id="show" tabindex='-1' role='dialog'
		aria-labelledby='myModalLabel' ng-controller="documentCtrl"
		ng-app="myApp" ng-hide="flagShow">
